...
class WakeupWordDetector(Thread):
    ...
    def __init__(
        ...
        if self._model_file_path is None:
        	self._model_file_path = os.path.join(os.path.dirname(__file__), './lib/common/porcupine_params.pv')
        
        self.wakeupWordDetected = False
        self.destroyTriggered = False
    ...
    def run(self):
        ...
        try:
            ...
            while (not self.destroyTriggered):
